...
public class PropertiesUtil {
     ...
     * @throws
     */
    public static String getProp4Type1(String filePath, String keyWord){
     ...
     * @throws
     */
    public static void getProp4Type1(String filePath){
        Properties prop = null;
        try {
            // 通过Spring中的PropertiesLoaderUtils工具类进行获取
            prop = PropertiesLoaderUtils.loadAllProperties(filePath);
     ...
     * @throws
     */
    public static String getProp4Type2(String filePath, String keyWord){
     ...
     * @throws
     */
    public static void getProp4Type2(String filePath){
        Properties prop = new Properties();
        try {
            // 通过输入缓冲流进行读取配置文件
            InputStream InputStream = new BufferedInputStream(new FileInputStream(new File(filePath)));
     ...
     * @throws
     */
    public static String getProp4Type3(String filePath, String keyWord){
        Properties prop = new Properties();
        String value = null;
        try {
     ...
     * @throws
     */
    public static Properties getProp4Type3(String filePath){
        Properties prop = new Properties();
        try {
            InputStream inputStream = PropertiesUtil.class.getResourceAsStream(filePath);
            prop.load(inputStream);
    ...
    public static void main(String[] args) {
        // 注意路径问题
        //String properties_1 = getProp4Type1("com/test/config/config.properties", "wechat_appid");
        //System.out.println("wechat_appid = " + properties_1);
        //getProp4Type1("com/test/config/config.properties");
        //System.out.println("*********************************************");
        // 注意路径问题
        //String properties_2 = getProp4Type2("configure/configure.properties", "jdbc.url");
        //System.out.println("jdbc.url = " + properties_2);
    	getProp4Type3("/config/globalset.properties");
        System.out.println("*********************************************");
        // 注意路径问题
        //String properties_3 = getProp4Type3("/com/test/config/config.properties", "wechat_appid");
        //System.out.println("wechat_appid = " + properties_3);
        //getProp4Type3("/com/test/config/config.properties");
    }
}
