...
/**
 * Description: [工作经历信息服务]
 * Created on 2021年03月29日
 * @author  <a href="mailto: jeenry@126.com">huadf</a>
 * @version 1.0 
 * Copyright (c) 2021年 xxxx
 */
public interface IChPmWorkExpeInfoBiz {
	 ...
	 * Created on 2021年03月29日
	 * @param page 工作经历信息数据分页条件
	 * @param model 工作经历信息数据查询条件
	 * @param queryFields 工作经历信息数据查询字段集合
	 * @return 分页数据
	 *													       	 
	 * @author:huadf
	 */
	 public	void queryPage(Page page, ChPmWorkExpeInfoModel model, String queryFields)throws Exception;
