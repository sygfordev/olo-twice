  ...
  <div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body">
			...
			<!-- 隐藏属性 -->
			<input type="hidden" id="wkId" name="wkId" value="${wkId}">
  ...
  layui.config({
    ...
    archives: 'archives'
    	...
    	element.on('tab(archivesTab)', function(obj){
    	    ...
    	    let indexArray = [2,3,4,5,6,7,8,9,13];
    	    url = (indexArray.includes(obj.index))?url+"/index.jhtm":url+"/edit.jhtm";
    	    url = url+(obj.index==0?"?id=":"?wkId=")+$("#wkId").val()+"&oper="+$("#oper").val();
    	    $("#"+targetTab).attr("src",url);
