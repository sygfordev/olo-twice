package com.hdfs.olo.olo_web.plugins.common.hutool.excel;
...
public class ExcelReader extends ExcelBase<ExcelReader> {
	...
	private static final Map<String,String> dd = new HashMap<String,String>();
	static {
		dd.put("姓名", "name");
		dd.put("身份证号", "cardNo");
		dd.put("银行卡号", "bankCardNo");
		dd.put("手机号码", "mobileNo");
	}
	
	public static void main(String args[])
	{
		ExcelReader reader = ExcelUtil.getReader("E:\\项目资料\\中央医院\\2020全院工资明细.xls", 0);
		reader.setHeaderAlias(dd);
