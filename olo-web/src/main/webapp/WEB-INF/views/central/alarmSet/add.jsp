...
<body>
  ...
  <div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
          <form class="layui-form" action="" lay-filter="alarmSet-add-form">
		  ...
		  <div class="layui-form-item">
		  	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="alarmAdSize" name="alarmAdSize" lay-verify="required|number|positiveWholeNumberRequiredTrue|alarmAdSize" autocomplete="off" placeholder="提前天/周/月....数量" class="layui-input">
	            </div>
            </div>
          	<div class="layui-inline">
          ...
          <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
              <textarea id="alarmTeInfo" name="alarmTeInfo" lay-verify="alarmTeInfo" placeholder="请输入警报样板  如：尊敬的运营人员您好，员工{name}的合同{contractno}将于1天后到期，请及时处理！" class="layui-textarea"></textarea>
            </div>
          </div>
          ...
          <div class="layui-form-item layui-layout-admin">
            <div class="layui-input-block">
              <div class="layui-footer" style="left: 0;">
                <button class="layui-btn" lay-submit="" lay-filter="LAY-alarmSet-add-submit" id="LAY-alarmSet-add-submit">立即提交</button>
  ...
  layui.config({
    ...
    form.render(null, 'alarmSet-add-form');
  });
  </script>
</body>
</html>