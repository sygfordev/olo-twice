...
<head>
  ...
  <script type="text/javascript" src="<%=basePath%>/layuiadmin/modules/rolePrivCfg.js"></script>
</head>
<body>
      ...
      <div class="layui-form">
      	<div class="layui-form-item">
      		<div class="layui-inline">
	            <label class="layui-form-label" style="width: 200px;">同步用户权限：</label>
	            <div class="layui-input-block" style="margin-left: 230px">
	              	<input type="radio" name="isAppend" value="0" title="是" checked>
	              	<input type="radio" name="isAppend" value="1" title="否">
	            </div>
            </div>
      	</div>
        <!-- <div class="layui-form-item">
        ...
        <!-- <div class="layui-form-item">
          ...
          <div class="layui-form-block">
            ...
            <button type="button" class="layui-btn layui-btn-primary" onclick="listConvert('test12.jhtm')">列表转树</button>
    ...
    <div class="layui-col-md6 layui-col-md-offset1">
      ...
      <!-- 此扩展能递归渲染一个权限树，点击深层次节点，父级节点中没有被选中的节点会被自动选中，单独点击父节点，子节点会全部 选中/去选中 -->
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block" style="width: 680px; height: 650px; overflow: auto; font-size: 0; margin-left: 210px">
            <div id="LAY-auth-tree-index"></div>
          </div>
        </div>
        <!-- <div class="layui-form-item">
          <div class="layui-input-block" style="margin-left: 310px">
            <button class="layui-btn" type="submit" lay-submit lay-filter="LAY-rolePriv-submit">提交</button>
