...
<body>
  ...
  <div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
          <form class="layui-form" action="" lay-filter="chSocialRecord-add-form">
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="batchUserAccount" name="batchUserAccount" lay-verify="required|batchUserAccount" autocomplete="off" placeholder="操作人账户" class="layui-input">
	            </div>
            </div>
          </div>
		  <div class="layui-form-item">
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="batchMsg" name="batchMsg" lay-verify="required|batchMsg" autocomplete="off" placeholder="批次消息" class="layui-input">
	            </div>
            </div>
          </div>
          ...
          <div class="layui-form-item layui-layout-admin">
            <div class="layui-input-block">
              <div class="layui-footer" style="left: 0;">
                <button class="layui-btn" lay-submit="" lay-filter="LAY-chSocialRecord-add-submit" id="LAY-chSocialRecord-add-submit">立即提交</button>
  ...
  }).use(['index','form','chSocialRecord'], function(){
    var $ = layui.$,
    form = layui.form;
    
    form.render(null, 'chSocialRecord-add-form');
  });
  </script>
</body>
</html>