...
layui.use(['jquery', 'authtree', 'form', 'layer'], function(){
  ...
  // 初始化
  $.ajax({
    url: 'test.jhtm?roleId='+$("#roleId").val(),
    method:'post',
    dataType: 'json',
...
//      obj.field.id = obj.field.roleId;
//      obj.field.systemPrivList = authids;
//      obj.field.isAppend = $('input[name="isAppend"]:checked').val();
  ...
  // 表单提交样例
  form.on('submit(LAY-rolePriv-submit)', function(obj){
    var authids = authtree.getChecked('#LAY-auth-tree-index');
