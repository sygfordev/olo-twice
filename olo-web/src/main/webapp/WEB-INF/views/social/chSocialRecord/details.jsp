...
<body>
      ...
      <div class="layui-card-body" style="padding: 15px;">
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="batchUserAccount" name="batchUserAccount" value="${model.batchUserAccount}" lay-verify="required|batchUserAccount" autocomplete="off" placeholder="请输入操作人账户" class="layui-input" readonly>
	            </div>
            </div>
          </div>
		  <div class="layui-form-item">
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="batchMsg" name="batchMsg" value="${model.batchMsg}" lay-verify="required|batchMsg" autocomplete="off" placeholder="请输入批次消息" class="layui-input" readonly>
	            </div>
            </div>
          </div>
  ...
  }).use(['index', 'laydate', 'chSocialRecord'], function(){
    var $ = layui.$;
