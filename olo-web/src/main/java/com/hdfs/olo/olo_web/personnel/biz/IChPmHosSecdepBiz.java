...
/**
 * Description: [医院二级科室表服务]
 * Created on 2021年04月02日
 * @author  <a href="mailto: jeenry@126.com">huadf</a>
 * @version 1.0 
 * Copyright (c) 2021年 xxxx
 */
public interface IChPmHosSecdepBiz {
	 ...
	 * Created on 2021年04月02日
	 * @param page 医院二级科室表数据分页条件
	 * @param model 医院二级科室表数据查询条件
	 * @param queryFields 医院二级科室表数据查询字段集合
	 * @return 分页数据
	 *													       	 
	 * @author:huadf
	 */
	 public	void queryPage(Page page, ChPmHosSecdepModel model, String queryFields)throws Exception;
