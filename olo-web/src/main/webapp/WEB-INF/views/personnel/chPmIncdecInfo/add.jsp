...
<body>
  ...
  <div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
          <form class="layui-form" action="" lay-filter="chPmIncdecInfo-add-form">
          <!-- 隐藏属性 -->
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="entryTime" name="entryTime" lay-verify="required" autocomplete="off" placeholder="进入时间" class="layui-input time">
	            </div>
            </div>
            <div class="layui-inline">
	            <label class="layui-form-label">进入渠道</label>
	            <div class="layui-input-inline">
	              <select id="entryChan" name="entryChan" lay-verify="required">
	              	<option value=""></option>
            ...
            <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="quitTime" name="quitTime" autocomplete="off" placeholder="离职时间" class="layui-input time">
	            </div>
            </div>
            <div class="layui-inline">
          ...
          <div class="layui-form-item layui-layout-admin">
            <div class="layui-input-block">
              <div class="layui-footer" style="left: 0;">
                <button class="layui-btn" lay-submit="" lay-filter="LAY-chPmIncdecInfo-add-submit" id="LAY-chPmIncdecInfo-add-submit">立即提交</button>
  ...
  layui.config({
    ...
    form.render(null, 'chPmIncdecInfo-add-form');
  });
  </script>
</body>
</html>