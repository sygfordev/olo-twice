		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="adjustMonth" name="adjustMonth" lay-verify="required|adjustMonth" autocomplete="off" placeholder="调资年月" class="layui-input">
	            </div>
            </div>
          </div>
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="adjustFormulas" name="adjustFormulas" lay-verify="required|adjustFormulas" autocomplete="off" placeholder="调资公式列表" class="layui-input">
	            </div>
            </div>
          </div>
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="adjustAccount" name="adjustAccount"  autocomplete="off" placeholder="操作账户" class="layui-input">
	            </div>
            </div>
          </div>
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="adjustUser" name="adjustUser"  autocomplete="off" placeholder="操作人" class="layui-input">
	            </div>
            </div>
          </div>
