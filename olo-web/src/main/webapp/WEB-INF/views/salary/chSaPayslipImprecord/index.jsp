...
<body>
      ...
      <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
		  ...
		  <div class="layui-inline">
	        ...
	        <div class="layui-input-block">
	          <input type="text" name="batchType" placeholder="请输入批次类型名称" autocomplete="off" class="layui-input">
	        </div>
          </div>
		  <div class="layui-inline">
          ...
          <div class="layui-inline">
            <button class="layui-btn layuiadmin-btn-admin" lay-submit lay-filter="LAY-chSaPayslipImprecord-search" data-type="search">
      ...
      <div class="layui-card-body">
        ...
        <div style="padding-bottom: 10px;">
          <div class="layui-btn-group">
          	<shiro:hasPermission name="chSaPayslipImprecord:add">
          	<button class="layui-btn layuiadmin-btn-admin" data-type="add">添加</button>
          	</shiro:hasPermission>
          	<shiro:hasPermission name="chSaPayslipImprecord:batchdel">
        ...
        <!-- 数据表格 -->
        <table id="LAY-chSaPayslipImprecord-manage" lay-filter="LAY-chSaPayslipImprecord-manage"></table>
        ...
        <!-- 操作模块 -->
        <script type="text/html" id="table-chSaPayslipImprecord-manager-operator">
          <shiro:hasPermission name="chSaPayslipImprecord:edit">
			<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit"><i class="layui-icon layui-icon-edit"></i>编辑</a>
		  </shiro:hasPermission>
		  <shiro:hasPermission name="chSaPayslipImprecord:delete">
			<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del"><i class="layui-icon layui-icon-delete"></i>删除</a>
		  </shiro:hasPermission>
		  <shiro:hasPermission name="chSaPayslipImprecord:details">
 ...
 <script src="<%=basePath%>layuiadmin/layui/layui.js"></script>
  ...
  layui.config({
    ...
    chSaPayslipImprecord: 'salary/chSaPayslipImprecord'
  }).use(['index', 'chSaPayslipImprecord', 'table','laypage'], function(){
  		var $ = layui.$;
  	});
  </script>
</body>
