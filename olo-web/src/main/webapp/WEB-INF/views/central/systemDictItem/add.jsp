...
<body>
  ...
  <div class="layui-fluid">
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
          <form class="layui-form" action="" lay-filter="systemDictItem-add-form">
          <input type="hidden" id="dictId" name="dictId" value="${dictId}" class="layui-input">
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            <label class="layui-form-label">字典项Key</label>
	            <div class="layui-input-inline">
	              <input type="text" id="itemKey" name="itemKey" lay-verify="required|itemKey" autocomplete="off" placeholder="字典项Key" class="layui-input">
	            </div>
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="itemVal" name="itemVal" autocomplete="off" lay-verify="required|itemVal" placeholder="字典项Val" class="layui-input">
	            </div>
		  ...
		  <div class="layui-form-item">
          	<div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	              <input type="text" id="sortVal" name="sortVal" lay-verify="required|sortVal" autocomplete="off" placeholder="排序" class="layui-input">
	            </div>
          ...
          <div class="layui-form-item layui-layout-admin">
            <div class="layui-input-block">
              <div class="layui-footer" style="left: 0;">
                <button class="layui-btn" lay-submit="" lay-filter="LAY-systemDictItem-add-submit" id="LAY-systemDictItem-add-submit">立即提交</button>
  ...
  layui.config({
    ...
    form.render(null, 'systemDictItem-add-form');
  });
  </script>
</body>
</html>